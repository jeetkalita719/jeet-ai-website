...
const questionsByCategory = [
  ...
  },
  {
    ...
    questions: [
      'What can you build for my business?',
      'I run a small store — how could a chatbot help me?',
      'Can you automate my repetitive work?',
  ...
  },
  {
    ...
    name: 'Projects',
    icon: CodeIcon,
    questions: ['What projects are you most proud of?', 'Tell me about the job-intelligence agent.', 'How does this website work?'],
  },
  {
    id: 'skills',
    name: 'Skills',
    icon: GraduationCapIcon,
    questions: ['What are your skills?', 'What is your experience with RAG and agents?', 'Can I see your resume?'],
  },
  {
    id: 'fun',
    name: 'Fun',
    icon: PartyPopper,
    questions: ['What do you do outside work?', 'Tell me something interesting about you.'],
  },
  {
    id: 'contact',
    name: 'Contact',
    icon: MailIcon,
    questions: ['How can I reach you?', 'How do we start a project together?'],
  },
];
